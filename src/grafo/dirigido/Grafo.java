...
//	        }
	...
	@SuppressWarnings("unchecked")
	public IteratorGrafo<T> BFSIterator(T carga) {
		return (IteratorGrafo<T>) new BFSIterator<T>(this.vertices, this.arestas, carga);
	}

	@SuppressWarnings("unchecked")
	public IteratorGrafo<T> DFSIterator(T carga) {
		return (IteratorGrafo<T>) new DFSIterator<T>(this.vertices, carga);
	}
